...
import net.yaiba.eat.tool.SlideBar;
...
public class MainActivity extends Activity implements  AdapterView.OnItemClickListener,AdapterView.OnItemLongClickListener{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		bn_go_add.setOnClickListener(new OnClickListener(){
			   ...
			   {
				   Intent mainIntent = new Intent(MainActivity.this,RecordAddActivity.class);
...
//				});
	...
	public void setUpViews(String type, String value){
		...
		if("all".equals(type)){
			mCursor = FoodDB.getAll("eat_time asc");
		} else if("search".equals(type)) {
			mCursor = FoodDB.getForSearch(value);
		}
        ...
        for(mCursor.moveToFirst();!mCursor.isAfterLast();mCursor.moveToNext()) {  
            int nameColumn = mCursor.getColumnIndex("food_name");
            int phoneColumn = mCursor.getColumnIndex("eat_time");
            ...
            map.put("food_name", siteName);
            map.put("eat_time", userName);
            listItem.add(map);
...
//		listItemLike = (ArrayList<HashMap<String, Object>>)listItem.clone();
        ...
        SimpleAdapter listItemAdapter = new SimpleAdapter(this,listItem,R.layout.record_items,
        	...
        	new String[] {"food_name", "eat_time"},
        	new int[] {R.id.food_name,R.id.eat_time}
        ); 
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		menu.add(Menu.NONE, MENU_ABOUT, 0, this.getString(R.string.menu_about));//关于Eat
		return true;
	}
	...
	public boolean onOptionsItemSelected(MenuItem item)
	{
		...
		{
			case MENU_ABOUT:
				title = this.getString(R.string.menu_about);//关于Eat
